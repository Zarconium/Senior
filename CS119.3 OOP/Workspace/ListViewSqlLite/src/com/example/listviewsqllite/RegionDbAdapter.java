...
public class RegionDbAdapter {
	...
	private static final String DATABASE_NAME = "Philippines";
	private static final String SQLITE_TABLE = "Regions";
	...
	public long createRegion(String name, String region) {
	...
	public Cursor fetchRegionsByName(String inputText) throws SQLException {
		...
		if (inputText == null || inputText.length() == 0) {
			...
			mCursor = mDb.query(SQLITE_TABLE, new String[] { KEY_ROWID,
					KEY_NAME, KEY_REGION }, null, null, null, null, null);

		} else {
			mCursor = mDb.query(true, SQLITE_TABLE, new String[] { KEY_ROWID,
					KEY_NAME, KEY_REGION }, KEY_NAME + " like '%" + inputText
